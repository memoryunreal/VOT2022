...
def parameters():
    ...
    # params.net = NetWithBackbone(net_path='/data1/gaoshang/Depth_Only_model/dimp50_D_Generated_DepthTrack/DiMPnet_ep0050.pth.tar',
    #                              use_gpu=params.use_gpu)

    params.net = NetWithBackbone(net_path='/home/VOT2022/vot2022/checkpoints/DiMPnet_ep0050_D3.pth.tar',
                                 use_gpu=params.use_gpu)
