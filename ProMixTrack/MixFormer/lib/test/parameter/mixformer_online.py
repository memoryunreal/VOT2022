...
def parameters(yaml_name: str, model=None, search_area_scale=None):
    ...
    # prj_dir = '/home/VOT2022/vot2022/votrgbd/MixFormer/'
    # save_dir = '/home/VOT2022/vot2022/votrgbd/MixFormer/lib/test/'
    ...
    if model is None:
        ...
        params.checkpoint = os.path.join(save_dir, "networks/%s" % model)
